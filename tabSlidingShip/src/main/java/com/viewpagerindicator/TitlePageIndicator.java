...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiTitlePageIndicatorStyle1);
    }
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TitlePageIndicator1, defStyle, 0);

        //Retrieve the colors to be used for this view and apply them.
        mFooterLineHeight = a.getDimension(R.styleable.TitlePageIndicator1_footerLineHeight1, defaultFooterLineHeight);
        mFooterIndicatorStyle = IndicatorStyle.fromValue(a.getInteger(R.styleable.TitlePageIndicator1_footerIndicatorStyle1, defaultFooterIndicatorStyle));
        mFooterIndicatorHeight = a.getDimension(R.styleable.TitlePageIndicator1_footerIndicatorHeight1, defaultFooterIndicatorHeight);
        mFooterIndicatorUnderlinePadding = a.getDimension(R.styleable.TitlePageIndicator1_footerIndicatorUnderlinePadding1, defaultFooterIndicatorUnderlinePadding);
        mFooterPadding = a.getDimension(R.styleable.TitlePageIndicator1_footerPadding1, defaultFooterPadding);
        mLinePosition = LinePosition.fromValue(a.getInteger(R.styleable.TitlePageIndicator1_linePosition1, defaultLinePosition));
        mTopPadding = a.getDimension(R.styleable.TitlePageIndicator1_topPadding1, defaultTopPadding);
        mTitlePadding = a.getDimension(R.styleable.TitlePageIndicator1_titlePadding1, defaultTitlePadding);
        mClipPadding = a.getDimension(R.styleable.TitlePageIndicator1_clipPadding1, defaultClipPadding);
        mColorSelected = a.getColor(R.styleable.TitlePageIndicator1_selectedColor1, defaultSelectedColor);
        mColorText = a.getColor(R.styleable.TitlePageIndicator1_android_textColor, defaultTextColor);
        mBoldText = a.getBoolean(R.styleable.TitlePageIndicator1_selectedBold1, defaultSelectedBold);

        final float textSize = a.getDimension(R.styleable.TitlePageIndicator1_android_textSize, defaultTextSize);
        final int footerColor = a.getColor(R.styleable.TitlePageIndicator1_footerColor1, defaultFooterColor);
        ...
        Drawable background = a.getDrawable(R.styleable.TitlePageIndicator1_android_background);
        if (background != null) {
